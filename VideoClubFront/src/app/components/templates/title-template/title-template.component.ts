...
export class TitleTemplateComponent implements OnInit {
  ...
  initializeTitleInfo(){
    this.ruleService.getTitleInfo().subscribe(
      (title : TitleInfo) => {
  ...
  setBronzeAcquire(){
    ...
    this.ruleService.setBronzeAquirePoints(points).subscribe(
      (response) => {
        if(!response.value){
  ...
  setSilverAcquire(){
    ...
    this.ruleService.setSilverAquirePoints(points).subscribe(
      (response) => {
        if(!response.value){
          this.errorMessage = response.result;
          this.greenMessage = "";
  ...
  setGoldAcquire(){
    ...
    this.ruleService.setGoldAquirePoints(points).subscribe(
      (response) => {
        if(!response.value){
          this.errorMessage = response.result;
          this.greenMessage = "";
  ...
  setBronzeSave(){
    ...
    this.ruleService.setBronzeSavePoints(points).subscribe(
      (response) => {
        if(!response.value){
          this.errorMessage = response.result;
          this.greenMessage = "";
  ...
  setSilverSave(){
    ...
    this.ruleService.setSilverSavePoints(points).subscribe(
      (response) => {
        if(!response.value){
          this.errorMessage = response.result;
          this.greenMessage = "";
  ...
  setGoldSave(){
    ...
    this.ruleService.setGoldSavePoints(points).subscribe(
      (response) => {
        if(!response.value){
          this.errorMessage = response.result;
          this.greenMessage = "";
  ...
  setBronzeReward(){
    ...
    this.ruleService.setBronzeRewardPoints(points).subscribe(
      (response) => {
        if(!response.value){
          this.errorMessage = response.result;
          this.greenMessage = "";
  ...
  setSilverReward(){
    ...
    this.ruleService.setSilverRewardPoints(points).subscribe(
      (response) => {
        if(!response.value){
          this.errorMessage = response.result;
          this.greenMessage = "";
  ...
  setGoldReward(){
    ...
    this.ruleService.setGoldRewardPoints(points).subscribe(
      (response) => {
        if(!response.value){
          this.errorMessage = response.result;
          this.greenMessage = "";
